module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			basic_and_extras: {
				files: {
					'dist/<%= pkg.name %>.min.js': ['src/controllers/root.js', 'src/controllers/*.js', 'src/directives/root.js', 'src/directives/*.js', 'src/filters/root.js', 'src/filters/*.js', '!src/vendor/**/*.js'],
